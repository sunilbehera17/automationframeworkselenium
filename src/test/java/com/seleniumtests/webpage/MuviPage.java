...
public class MuviPage extends PageObject{
...
public MuviPage(final boolean openPageURL) throws Exception {
...
public MuviPage Textbox(TextFieldElement element,final String Text) throws Exception {
	waitForSeconds(2);
	element.clearAndType(Text);
    return this;
} 
public MuviPage MouseOver(HtmlElement element) throws Exception {
 ...
 public MuviPage Click(ButtonElement element) throws Exception {
	   
	   element.waitForPresent(10);
	   element.click();
        return this;
    }
 public MuviPage Click1(ButtonElement element) throws Exception {
	 waitForSeconds(10);
 	try {
	    element.click();
 	}catch(Exception e) {
 ...
 public MuviPage Scroll(ButtonElement element) throws Exception {
	 waitForSeconds(2);
	    element.scroll();
     return this;
 }
 ...
 public MuviPage SimulateClick(ButtonElement element) throws Exception {
	 waitForSeconds(2);
	    element.simulateClick();
     return this;
 }
 public MuviPage HtmlvideoPlayerPlay(HtmlElement element) throws Exception {
	 waitForSeconds(2);
	    element.HtmlvideoPlayerPlay();
     return this;
 }
 public MuviPage HtmlvideoPlayerPause(HtmlElement element) throws Exception {
	 waitForSeconds(2);
	    element.HtmlvideoPlayerPause();
     return this;
 }
 
 public MuviPage selectNewTab() throws Exception {
	 waitForSeconds(2);
 	selectNewWindow();
	return this;
     
 }
 public MuviPage SelectWindow(int index) throws Exception {
	 waitForSeconds(2);
	 	selectWindow(index);
		return this;
 ...
 public MuviPage Wait(int value) throws Exception {
	 waitForSeconds(value);
	 	
		return this;
	     
	 }
 public MuviPage SelectByList(final String Text,String xpath) throws Exception {
	 waitForSeconds(5);
 ...
 public MuviPage SelectByListIndex(final int index,String xpath) throws Exception {
	 waitForSeconds(5);
...
//		     
//		 }
 public MuviPage GoBack() throws Exception {
 ...
 public MuviPage Uncheck(final CheckBoxElement element ) throws Exception {
		
	       element.uncheck();
			return this;
		     
		 }
 public MuviPage Check(final CheckBoxElement element ) throws Exception {
		
     element.check();
		return this;
	     
	 }
 public MuviPage GetCompairText(final MuviData MuviData,ButtonElement element) throws Exception {
 ...
 public MuviPage randomData(final MuviData MuviData) throws Exception {
 ...
 public MuviPage AssertEquals(final String actualText,final String expectedText) throws Exception {
	 assertEquals(actualText.toLowerCase(),expectedText.toLowerCase(),"Actual text and Expected Text Not Equal");
     return this;
    }
 public MuviPage AssertFalse(final Boolean actualText) throws Exception {
	 assertFalse(actualText,"Text should not be visible but now its visible");
     return this;
    }
 public MuviPage AssertTrue(final Boolean actualText) throws Exception {
	 assertTrue(actualText,"Text should  be visible but now its not visible");
     return this;
    }
 
 public MuviPage LoginInMuviAdmin(final MuviData MuviData) throws Exception {
 ...
 public MuviPage Register_Taking_Up_All_Content_Subscription_Plan(final MuviData MuviData) throws Exception {
 ...
 public MuviPage  Register_Subscription_Notenabled(final MuviData MuviData) throws Exception {
	 return   Click(LoginButton_HomePage)
			  .Textbox(LoginUserNameTextbox,MuviData.getLoginUserName())
 			  .Textbox(LoginPassWordTextbox,MuviData.getLoginPassWord())
 			  .Click(LoginButton_LoginPage)
 ...
 public MuviPage Purchase_Single_Part_Content(final MuviData MuviData) throws Exception {
	 return    Click(LoginButton_HomePage)
			  .Textbox(LoginUserNameTextbox,MuviData.getLoginUserName())
 			  .Textbox(LoginPassWordTextbox,MuviData.getLoginPassWord())
 			  .Click(LoginButton_LoginPage)
 ...
 public MuviPage player(final MuviData MuviData) throws Exception {
