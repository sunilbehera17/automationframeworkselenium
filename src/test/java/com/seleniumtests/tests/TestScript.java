...
public class TestScript {
	...
	private static final String URL = "https://mailsac.com/api/addresses/";
	...
	public void testGETMethod() {
		 ...
		 */
		    executor.get("/bricks/mobileLogin.html?username=test1@yopmail.com&password=test01&campCode=wap/bricks/mobileLogin.html?username=test1@yopmail.com&password=test01&campCode=wap")
...
/*		executor.get("/posts/1")
	...
	public static void main(String args []) {
		 ...
		 * Initialize RestExecutor object using the end point URL
		 */
		RandomEmailID.randomEmail();
		executor = new RestExecutor(URL);
		 //executor.get(RandomEmailID.email+"/messages")
		executor.get("mbqc20171025120457@mailsac.com"+"/messages")
		.expectCode(200)		// Expected code of 200
		.printBody();
	}
}